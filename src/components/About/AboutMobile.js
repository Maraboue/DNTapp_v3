    ...
    render() {
        ...
        return (
            <section className="about_section" id="aboutmobile">
                <body>
                <div id="AboutHeaderM" className="AboutHeaderM">
                    <h1 className="gradient-text">About DNT</h1>
                </div>


                <div id="AboutContainerM" className="AboutContainerM" >
                    <div id="AboutItemM" className="AboutItemM">
                        <div id="BackgroundM" className="BackgroundM">
